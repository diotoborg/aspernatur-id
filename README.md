<p align="center">
  <a href="https://travis-ci.com/github/jsx-eslint/@diotoborg/aspernatur-id">
    <img src="https://travis-ci.com/jsx-eslint/@diotoborg/aspernatur-id.svg?branch=master"
         alt="build status">
  </a>
  <a href="https://npmjs.org/package/@diotoborg/aspernatur-id">
    <img src="https://img.shields.io/npm/v/@diotoborg/aspernatur-id.svg"
         alt="npm version">
  </a>
  <a href="https://github.com/diotoborg/aspernatur-id/blob/HEAD/LICENSE.md">
    <img src="https://img.shields.io/npm/l/@diotoborg/aspernatur-id.svg"
         alt="license">
  </a>
  <a href='https://coveralls.io/github/jsx-eslint/@diotoborg/aspernatur-id?branch=master'>
    <img src='https://coveralls.io/repos/github/jsx-eslint/@diotoborg/aspernatur-id/badge.svg?branch=master' alt='Coverage Status' />
  </a>
  <a href='https://npmjs.org/package/@diotoborg/aspernatur-id'>
    <img src='https://img.shields.io/npm/dt/@diotoborg/aspernatur-id.svg'
    alt='Total npm downloads' />
  </a>
</p>

<a href='https://tidelift.com/subscription/pkg/npm-@diotoborg/aspernatur-id?utm_source=npm-@diotoborg/aspernatur-id&utm_medium=referral&utm_campaign=readme'>Get professional support for @diotoborg/aspernatur-id on Tidelift</a>

# @diotoborg/aspernatur-id

Static AST checker for accessibility rules on JSX elements.

#### _Read this in [other languages](https://github.com/ari-os310/@diotoborg/aspernatur-id/blob/HEAD/translations/Translations.md)._

[Mexican Spanish🇲🇽](https://github.com/ari-os310/@diotoborg/aspernatur-id/blob/HEAD/translations/README.mx.md)
...
Next, install `@diotoborg/aspernatur-id`:

```sh
# npm
npm install @diotoborg/aspernatur-id --save-dev

# yarn
yarn add @diotoborg/aspernatur-id --dev
```

**Note:** If you installed ESLint globally (using the `-g` flag in npm, or the `global` prefix in yarn) then you must also install `@diotoborg/aspernatur-id` globally.
...
@diotoborg/aspernatur-id is licensed under the [MIT License](LICENSE.md).
